                                            ...
                                            const int height_in, const int width_in, const int kernel_height)
{
    ...
    cudaMalloc((void **)&d_weight, output_channel * input_channel * kernel_height * kernel_height * sizeof(float));  // input_channel * output_channel filter Maps of size kernel_height * kernel_height
	...
	time_kernel.Start();
    conv_forward_kernel<<<num_blocks_in_grid, num_threads_per_block>>>(d_output, d_input, d_weight, num_samples, output_channel, input_channel, height_in, width_in, kernel_height);
    time_kernel.Stop();
