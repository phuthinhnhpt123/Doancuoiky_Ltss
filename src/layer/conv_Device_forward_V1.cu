                                            ...
                                            const int height_in, const int width_in, const int kernel_height)
{
	...
	time_kernel.Start();
    conv_forward_kernel<<<num_blocks_in_grid, num_threads_per_block>>>(device_output, d_input, num_samples, output_channel, input_channel, height_in, width_in, kernel_height);
    time_kernel.Stop();
